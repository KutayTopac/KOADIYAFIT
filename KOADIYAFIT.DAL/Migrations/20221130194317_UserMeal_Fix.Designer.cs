...
namespace KOADIYAFIT.DAL.Migrations
{
    ...
    [Migration("20221130194317_UserMeal_Fix")]
    partial class UserMeal_Fix
    {
            ...
            modelBuilder.Entity("FoodUserMeal", b =>
                {
                    ...
                    b.Property<int>("UserMealsUserMealId")
                        .HasColumnType("int");

                    b.HasKey("FoodsFoodId", "UserMealsUserMealId");

                    b.HasIndex("UserMealsUserMealId");
            ...
            modelBuilder.Entity("FoodUserMeal", b =>
                {
                    ...
                    b.HasOne("KOADIYAFIT.DATA.Entities.UserMeal", null)
                        .WithMany()
                        .HasForeignKey("UserMealsUserMealId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
